...
import com.yelzhan.jdbc.util.DataAccessObject;
...
public class CustomerDAO extends DataAccessObject<Customer> {
    private final String INSERT = "INSERT INTO customer (first_name, last_name, email, phone, address, city, state, zipcode) " +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
